...
@Autonomous
public class hatredanddepressionbluefar extends LinearOpMode {

    OpenCvWebcam webcam1 = null;
    int position = 0; //0 = left, 1 = middle, 2 = right
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            ...
            if (position == 0) {
                ...
                roboController.moveOnXAxis(RoboController.inchesToCounts(-150));
                //roboController.moveOnYAxis(RoboController.inchesToCounts(26));


                //roboController.moveOnYAxis(RoboController.inchesToCounts(1));
                //roboController.
//                roboController.moveOnYAxis(RoboController.inchesToCounts(26));
//                roboController.Spin(RoboController.inchesToCounts(-19));
//                roboController.ClawR.setPosition(0.4);
//                sleep(5000);
//                roboController.moveOnYAxis(RoboController.inchesToCounts(-40));
